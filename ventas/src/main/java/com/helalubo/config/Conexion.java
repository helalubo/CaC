...
public class Conexion {
    ...
    private static final String SQL_URL = "jdbc:mysql://localhost:3306/ventas_db?useSSL=false&useTimezone=true&serverTimezone=UTC&allowPublicKeyRetrieval=true";
